...
class ExampleController
{
    ...
    public static function admin_page()
    {
        ...
        ?>
        <div class="wrap">
            <h1><?php echo esc_html(__('Example Form', 'antonella-framework')); ?></h1>
            ...
            <form method="post" action="">
                ...
                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label for="name"><?php echo esc_html(__('Name', 'antonella-framework')); ?></label>
                        </th>
                        <td>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="email"><?php echo esc_html(__('Email', 'antonella-framework')); ?></label>
                        </th>
                        <td>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="message"><?php echo esc_html(__('Message', 'antonella-framework')); ?></label>
                        </th>
                        <td>
                ...
                <?php submit_button(__('Save Changes', 'antonella-framework')); ?>
            </form>
        </div>
        <?php
    }
